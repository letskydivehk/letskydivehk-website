...
export default function MembershipTiers() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      <SEO title={t("tiers.title")} description={t("tiers.subtitle")} path="/membership/tiers" />
      <PageNavbar />
      ...
      <main className="relative z-10 pt-24 pb-20">
        <div className="container max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-4">{t("tiers.title")}</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">{t("tiers.subtitle")}</p>
          </motion.div>
            ...
            {tiers.map((tier: any, index: number) => {
              ...
              return (
                <motion.div
                  ...
                  className={`rounded-xl border bg-card p-6 relative overflow-hidden ${
