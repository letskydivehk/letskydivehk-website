...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "souvenirs.uploadHint": "JPG or PNG, up to 10 MB. We'll print exactly what you send — high-resolution images look best.",
   ...
   "souvenirs.editionDesc": "Pick from our limited Skydiving Edition designs. Same 5 × 5 cm fridge magnet, shipped from Hong Kong.",
   ...
   "souvenirs.teaser.subtitle": "Turn your skydive photo into a real 5×5 cm fridge magnet — a daily reminder of the day you stepped out of a plane.",
   ...
   "souvenirs.testimonials.n2": "Marcus, A-Licence — Huizhou",
  ...
  "zh-TW": {
    ...
    "souvenirs.magnetWhatsappMsgNoPhoto": "你好！我想訂購客製化相片磁石貼（數量：{qty}，HK${price}）。我會在對話中傳送相片給你。",
    "souvenirs.magnetWhatsappMsgMember": "你好！我想訂購客製化相片磁石貼（數量：{qty}，HK${price}），並使用會員9折優惠。我的相片：{photo}",
   ...
   "souvenirs.testimonials.n2": "Marcus — 惠州 A-Licence",
   ...
   "souvenirs.bundles.friends.desc": "5 塊自訂相片磁石 — 一塊自己留念，四塊送給跳傘日的親友。",
  ...
  "zh-CN": {
    ...
    "souvenirs.magnetWhatsappMsgNoPhoto": "你好！我想订购客制化相片磁石贴（数量：{qty}，HK${price}）。我会在对话中发送相片给你。",
    "souvenirs.magnetWhatsappMsgMember": "你好！我想订购客制化相片磁石贴（数量：{qty}，HK${price}），并使用会员9折优惠。我的相片：{photo}",
    ...
    "souvenirs.bundles.friends.desc": "5 块自定义照片磁贴 — 一块自己留念，四块送给跳伞日的亲友。",
...
const dataTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "tour.price": "Price",
    "include.Local transportation (incl. airport / dropzone transfer)": "Local transportation (incl. airport / dropzone transfer)",
