...
const dataTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "servicePage.tour.faq.q1": "Are flights included?",
    "servicePage.tour.faq.a1": "Yes — international packages include round-trip flights. China packages include ground transfers from Hong Kong.",
    ...
    "servicePage.tour.faq.a3": "Yes. If weather prevents jumping, we'll reschedule within your tour window or refund the jump portion.",
