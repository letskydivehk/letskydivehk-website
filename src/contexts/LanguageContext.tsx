...
const translations: Record<Language, Record<string, string>> = {
  ...
  "zh-TW": {
    ...
    "article1": {
      "title": "第一條：資格、健康與安全",
      "content": [
        "1.1 參加者必須於活動當日年滿18歲，並出示附有相片之有效香港身份證或旅遊證件以供核實。",
    ...
    "article2": {
      ...
      "content": [
        ...
        "2.2 **豁免、放棄索償及彌償：** 為換取本公司提供本服務，參加者在此代表其本人、其繼承人、遺囑執行人及遺產管理人，作出以下不可撤銷之承諾：",
        "    (a) **完全免除、放棄及永久解除** 本公司、其董事、高級職員、僱員、合約教練、代理人、分包商及航空服務供應商（統稱「被豁免方」）因本服務引致或與之相關之任何及所有索償、要求、訴訟因由、損失、法律責任、損害賠償、費用及開支（包括合理律師費），**無論該等責任因被豁免方之任何疏忽、過失、違反法定責任或其他原因而產生，亦不論是否因本公司所提供之設備、場所或航空器之任何潛在缺陷而引致，惟法律明令禁止豁免之故意失當行為或重大過失除外。**",
        "    (b) **同意彌償並使被豁免方免受損害**，保障其免受因參加者參與本服務、違反本條款任何保證或規定、或其任何作為或不作為而直接或間接導致之任何及所有索償、法律責任、損害及開支。",
    ...
    "article3": {
      ...
      "content": [
        ...
        "3.2 **取消及改期政策：**",
        "    (a) **由參加者提出取消：**",
        "        (i) 於預定活動日 **14天或之前** 通知取消，可免費改期至另一可供預訂之日期。",
        "        (ii) 於預定活動日 **前7至14天內** 通知取消，可獲退還已支付費用之 **50%**。",
        "        (iii) 於預定活動日 **前7天內（含第7天）** 通知取消，或於活動當日未能出席（「No-Show」），**所有已支付費用將概不退還**。",
        "    (b) **由本公司提出取消/改期：**",
        "        (i) 若因安全理由（包括但不限於惡劣天氣、風速過高、能見度不足、雲層過低）或任何超出本公司合理控制範圍之情況（如航空器故障、維修、空中交通管制、政府指令、疫症限制等）導致活動無法進行，本公司將盡力協助參加者改期。",
        "        (ii) 若無法改期或參加者不接受建議之改期日期，本公司將全數退還參加者已支付之活動費用。",
        "        (iii) **在此等情況下，本公司對參加者因此產生之任何附帶、衍生或間接損失（包括但不限於交通、住宿、假期損失等）概不負責，參加者亦不得就此提出任何索償。**",
    ...
    "article4": {
      ...
      "content": [
        "4.1 參加者必須於指定時間到達指定集合地點。遲到者可能導致活動被取消，且不獲退款。",
    ...
    "article7": {
      "title": "第七條：一般條款",
      "content": [
        "7.1 **完整性：** 本條款構成雙方就本服務之完整協議，取代所有先前之討論、通訊及協議。",
        ...
        "7.4 **通知：** 所有通知應以電郵或本公司網站公告方式發出。"
      ]
    },
    "additionalNotes": {
      "title": "額外注意事項",
      "content": [
        "- 為使各參加者獲得完善的保障，本公司建議參加者必須購買旅遊保險。",
        "- 本公司保留權利修改本細則責任條款。如有任何爭議，本公司保留最終決定權。",
        "- 本細則責任條款只備有中文版本，一概以中文版本為準。",
        "- 本公司保留接受報名與否之最終權利。"
      ]
    },
