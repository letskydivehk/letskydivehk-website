...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "terms.section1.content": "By confirming a booking, making any payment, or participating in Let's Skydive HK Limited services, you acknowledge that you have read, understood, and *unconditionally accept* all contents of these Terms, which are legally binding upon you. If you are making a booking on behalf of others, you are deemed to have obtained full authorisation from those individuals to accept these Terms on their behalf.",

    "terms.section2.title": "2. Eligibility, Health, and Safety",
    "terms.section2.content": "Participants must be at least *18 years old* on the activity date and present valid identification. Weight must not exceed *100 kilograms*, and height-to-weight ratio must comply with safety equipment specifications. Participants must confirm they do not suffer from conditions including but not limited to: *heart disease, hypertension, spinal or neck injuries, epilepsy, pneumothorax, pregnancy, or any condition aggravated by air pressure or impact*. Participants must not be under the influence of alcohol, drugs, or substances impairing judgment. The Company reserves the right to refuse participation without refund.",

    "terms.section3.title": "3. Booking, Payment, Cancellation, and Rescheduling",
    "terms.section3.content": "Bookings are confirmed only upon deposit payment. Full balance must be settled before the deadline. Cancellation by Participant: *14+ days before activity*: free rescheduling; *7–14 days*: 50% refund; *within 7 days or no-show*: no refund. Cancellation by Company due to safety or uncontrollable circumstances: rescheduling will be offered or a full refund provided. The Company shall not be liable for incidental or consequential losses (e.g., travel, accommodation).",

    "terms.section4.title": "4. Acknowledgement of Risk and Liability Waiver",
    "terms.section4.content": "Skydiving is an *extreme sport with inherent risks* including serious injury or death. Participants *fully release, waive, and discharge* the Company and its affiliates from all claims, except for willful misconduct or gross negligence. Participants also *agree to indemnify and hold harmless* the Company against claims arising from their participation. The Company's liability is limited to the total service fee paid.",

    "terms.section5.title": "5. Rules of Conduct and Customer Responsibilities",
    "terms.section5.content": "Participants must arrive on time, attend mandatory safety briefings, and follow all instructions. Unsafe behaviour will result in termination without refund. Appropriate sportswear and closed-toe shoes are required. The Company provides safety equipment, which must not be tampered with. Participants are responsible for personal belongings; the Company is not liable for loss or damage.",

    "terms.section6.title": "6. Insurance and Personal Data",
    "terms.section6.content": "The Company maintains third-party liability insurance as required by law. *This insurance does not cover personal accident or injury to the Participant.* Participants are strongly advised to purchase personal accident insurance explicitly covering skydiving. Personal data collected will be used solely for bookings, service provision, safety, and administration, in compliance with the Personal Data (Privacy) Ordinance.",

    "terms.section7.title": "7. Use of Images",
    "terms.section7.content": "The Company may take photographs or videos during the activity for safety, training, quality control, and promotional purposes. Unless the Participant explicitly objects in writing before the activity, they grant the Company a *perpetual, royalty-free, irrevocable, worldwide license* to use such Images.",

    "terms.section8.title": "8. General Provisions",
    "terms.section8.content": "These Terms constitute the *entire agreement* between the parties. If any part is invalid, the remainder remains enforceable. The Company reserves the right to amend these Terms, with updates published on its website. Notices will be issued via email or website announcements. In case of dispute, the Company's decision shall be final. The governing version of these Terms is the Traditional Chinese version.",
  ...
  "zh-TW": {
    ...
    "terms.title": "服務條款",
    "terms.lastUpdated": "最後更新時間：2026年1月30日",
    ...
    "terms.article5.content": "5.1 本公司已購買法律要求之第三者責任保險。**此保險並不涵蓋參加者之人身意外傷害。** 本公司強烈建議參加者自行購買足額之個人意外保險，且該保險須明確承保「跳傘」或「高危體育活動」。<br><br>5.2 為遵守《個人資料（私隱）條例》，本公司收集之個人資料將僅用於處理預訂、提供服務、安全及內部行政之用。詳情請參閱本公司之私隱政策聲明。",
    ...
    "terms.article7.content": "7.1 **完整性：** 本條款構成雙方就本服務之完整協議，取代所有先前之討論、通訊及協議。<br><br>7.2 **可分割性：** 若本條款任何部分被有管轄權之法院裁定為無效或不可執行，該部分應在最小必要範圍內被分割，其餘部分仍保持完全效力。<br><br>7.3 **修改權：** 本公司保留隨時修訂本條款之權利。修訂後之條款將公佈於本公司官方網站。參加者於修訂後繼續使用服務，即表示接受經修訂之條款。<br><br>7.4 **通知：** 所有通知應以電郵或本公司網站公告方式發出。",
    ...
    "terms.importantConfirmation.content": "**本人（即參加者）確認已仔細閱讀並完全明白本《條款及細則》之全部內容，特別是其中以粗體標示之部分。本人清楚知悉跳傘活動之固有風險，並自願承擔此等風險。本人理解並同意本條款中關於責任豁免、放棄索償及彌償之規定，此乃本人參與活動之必要條件。**",
