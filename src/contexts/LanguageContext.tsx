...
const translations: Record<Language, Record<string, string>> = {
  ...
  "zh-TW": {
    ...
    "terms.sections.preamble.title": "前言",
    "terms.sections.preamble.content": "1.1 本《條款及細則》（下稱「本條款」）構成閣下（下稱「參加者」或「客戶」）與Let's Skydive HK Limited（下稱「本公司」或「我們」）就提供跳傘活動服務（下稱「本服務」）所訂立之法律協議。本條款受香港特別行政區法律管轄及解釋。<br><br>1.2 閣下透過任何途徑確認預訂、支付款項或參與本服務，即表示閣下已閱讀、理解並無條件接受本條款之全部內容，對閣下具有法律約束力。若閣下為他人代為預訂，即被視為已獲該等人士之充分授權代表其同意受本條款約束。",
    
    "terms.sections.article1.title": "第一條：資格、健康與安全",
    "terms.sections.article1.content": "1.1 參加者必須於活動當日年滿18歲，並出示附有相片之有效香港身份證或旅遊證件以供核實。<br><br>1.2 參加者之體重必須為100公斤或以下，且身高體重比例須符合本公司所使用安全裝備之操作規格。本公司保留於活動當日進行最終測量之權利。若參加者超出此安全限制，本公司有權單方面拒絕其參與，已繳付之所有費用將不予退還。<br><br>1.3 參加者聲明其身心健康狀況良好，適宜參與高空及高強度之體育活動。**參加者必須確認並保證其並無以下任何狀況（包括但不限於）：心臟病、高血壓、脊椎或頸部損傷、癲癇、氣胸、懷孕或可能懷孕、任何可能因氣壓變化或劇烈衝擊而惡化之病症，以及任何精神狀況以致影響其理解安全指示或判斷風險之能力。** 本公司強烈建議參加者在預訂前諮詢合資格醫生以評估自身狀況。<br><br>1.4 參加者在參與活動前及期間，不得受酒精、非法藥物或任何可能損害神智、判斷力、協調能力或反應能力之藥物影響。本公司職員有絕對酌情權判斷參加者是否適合參與，若判斷為不適合，有權即時取消其參與資格而不作退款。",
    
    "terms.sections.article2.title": "第二條：風險確認與責任豁免",
    "terms.sections.article2.content": "2.1 **固有風險之確認：** 參加者明確知悉、理解並承認，跳傘乃一項具有固有及顯著風險之極限運動，此等風險可導致嚴重身體受傷、永久傷殘、甚或死亡。此等風險包括但不限於：起飛、飛行或降落時之航空器事故；跳出航空器、自由墜落、開傘或著陸過程中發生之碰撞；裝備故障、失靈或不當使用；天氣狀況突然變化；教練、參加者、其他人士或第三方之錯誤判斷或疏忽；以及著陸於非預定區域或與障礙物碰撞。<br><br>2.2 **豁免、放棄索償及彌償：** 為換取本公司提供本服務，參加者在此代表其本人、其繼承人、遺囑執行人及遺產管理人，作出以下不可撤銷之承諾：<br><br>(a) **完全免除、放棄及永久解除** 本公司、其董事、高級職員、僱員、合約教練、代理人、分包商及航空服務供應商（統稱「被豁免方」）因本服務引致或與之相關之任何及所有索償、要求、訴訟因由、損失、法律責任、損害賠償、費用及開支（包括合理律師費），**無論該等責任因被豁免方之任何疏忽、過失、違反法定責任或其他原因而產生，亦不論是否因本公司所提供之設備、場所或航空器之任何潛在缺陷而引致，惟法律明令禁止豁免之故意失當行為或重大過失除外。**<br><br>(b) **同意彌償並使被豁免方免受損害**，保障其免受因參加者參與本服務、違反本條款任何保證或規定、或其任何作為或不作為而直接或間接導致之任何及所有索償、法律責任、損害及開支。<br><br>2.3 **責任上限：** 在法律允許之最大範圍內，本公司因本條款或本服務而對參加者所負之全部責任，不論於合約法、侵權法（包括疏忽）或其他法律原則下產生，其總額均不得超過參加者就該次活動向本公司支付之服務費用。",
    
    "terms.sections.article3.title": "第三條：預訂、付款、取消及改期",
    "terms.sections.article3.content": "3.1 預訂必須於本公司指定之期限內支付訂金方告確認。餘款須於活動日前指定期限內全數繳清。逾期未付，本公司有權取消預訂，已付訂金將不予退還。<br><br>3.2 **取消及改期政策：**<br><br>(a) **由參加者提出取消：**<br>• 於預定活動日 **14天或之前** 通知取消，可免費改期至另一可供預訂之日期。<br>• 於預定活動日 **前7至14天內** 通知取消，可獲退還已支付費用之 **50%**。<br>• 於預定活動日 **前7天內（含第7天）** 通知取消，或於活動當日未能出席（「No-Show」），**所有已支付費用將概不退還**。<br><br>(b) **由本公司提出取消/改期：**<br>• 若因安全理由（包括但不限於惡劣天氣、風速過高、能見度不足、雲層過低）或任何超出本公司合理控制範圍之情況（如航空器故障、維修、空中交通管制、政府指令、疫症限制等）導致活動無法進行，本公司將盡力協助參加者改期。<br>• 若無法改期或參加者不接受建議之改期日期，本公司將全數退還參加者已支付之活動費用。<br>• **在此等情況下，本公司對參加者因此產生之任何附帶、衍生或間接損失（包括但不限於交通、住宿、假期損失等）概不負責，參加者亦不得就此提出任何索償。**<br><br>3.3 所有取消或改期要求必須經由本公司指定之聯絡方式（如電話、電郵）提出並獲得書面確認，方為有效。",
    
    "terms.sections.article4.title": "第四條：活動當日守則與客戶責任",
    "terms.sections.article4.content": "4.1 參加者必須於指定時間到達指定集合地點。遲到者可能導致活動被取消，且不獲退款。<br><br>4.2 參加者必須參與強制性的安全簡報，並於活動全程嚴格遵守本公司教練及工作人員之一切指示。任何危害自身或他人安全之行為，將導致即時終止參與資格而不作退款。<br><br>4.3 參加者需自備合適之運動服裝及包覆腳踝之運動鞋。本公司將提供所有必要之安全裝備（包括跳傘服、頭盔、護目鏡等）。參加者不得擅自調校或干預任何裝備。<br><br>4.4 參加者須自行保管其個人物品。本公司對任何置於本公司場所、車輛或航空器內之財物之損失或損壞概不負責。",
    
    "terms.sections.article5.title": "第五條：保險與個人資料",
    "terms.sections.article5.content": "5.1 本公司已購買法律要求之第三者責任保險。**此保險並不涵蓋參加者之人身意外傷害。** 本公司強烈建議參加者自行購買足額之個人意外保險，且該保險須明確承保「跳傘」或「高危體育活動」。<br><br>5.2 為遵守《個人資料（私隱）條例》，本公司收集之個人資料將僅用於處理預訂、提供服務、安全及內部行政之用。詳情請參閱本公司之私隱政策聲明。",
    
    "terms.sections.article6.title": "第六條：影像使用",
