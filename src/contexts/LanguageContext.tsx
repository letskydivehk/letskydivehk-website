...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "terms.article7.content":
      "7.1 **Entire Agreement:** These Terms constitute the entire agreement between the parties regarding the Service and supersede all prior discussions, communications, and agreements.<br><br>7.2 **Severability:** If any part of these Terms is held to be invalid or unenforceable by a court of competent jurisdiction, that part shall be severed to the minimum extent necessary, and the remaining parts shall remain in full force and effect.<br><br>7.3 **Right to Amend:** The Company reserves the right to amend these Terms at any time. The amended Terms will be published on the Company's official website. Continued use of the Service by the Participant after such amendments constitutes acceptance of the revised Terms.<br><br>7.4 **Notices:** All notices shall be issued via email or announcement on the Company's website.",
  ...
  "zh-TW": {
    ...
    "terms.article5.content":
      "5.1 本公司已購買法律要求之第三者責任保險。**此保險並不涵蓋參加者之人身意外傷害。** 本公司強烈建議參加者自行購買足額之個人意外保險，且該保險須明確承保「跳傘」或「高危體育活動」。<br><br>5.2 為遵守《個人資料（私隱）條例》，本公司收集之個人資料將僅用於處理預訂、提供服務、安全及內部行政之用。詳情請參閱本公司之私隱政策聲明。",
    ...
    "terms.article7.content":
      "7.1 **完整性：** 本條款構成雙方就本服務之完整協議，取代所有先前之討論、通訊及協議。<br><br>7.2 **可分割性：** 若本條款任何部分被有管轄權之法院裁定為無效或不可執行，該部分應在最小必要範圍內被分割，其餘部分仍保持完全效力。<br><br>7.3 **修改權：** 本公司保留隨時修訂本條款之權利。修訂後之條款將公佈於本公司官方網站。參加者於修訂後繼續使用服務，即表示接受經修訂之條款。<br><br>7.4 **通知：** 所有通知應以電郵或本公司網站公告方式發出。",
