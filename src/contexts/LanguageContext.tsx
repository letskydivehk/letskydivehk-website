...
const translations: Record<Language, Record<string, string>> = {
  ...
  "zh-TW": {
    ...
    "terms.article2.content": "2.1 固有風險之確認：參加者明確知悉、理解並承認，跳傘乃一項具有固有及顯著風險之極限運動，此等風險可導致嚴重身體受傷、永久傷殘、甚或死亡。此等風險包括但不限於：起飛、飛行或降落時之航空器事故；跳出航空器、自由墜落、開傘或著陸過程中發生之碰撞；裝備故障、失靈或不當使用；天氣狀況突然變化；教練、參加者、其他人士或第三方之錯誤判斷或疏忽；以及著陸於非預定區域或與障礙物碰撞。<br><br>2.2 豁免、放棄索償及彌償：為換取本公司提供本服務，參加者在此代表其本人、其繼承人、遺囑執行人及遺產管理人，作出以下不可撤銷之承諾：(a) 完全免除、放棄及永久解除本公司、其董事、高級職員、僱員、合約教練、代理人、分包商及航空服務供應商（統稱「被豁免方」）因本服務引致或與之相關之任何及所有索償、要求、訴訟因由、損失、法律責任、損害賠償、費用及開支（包括合理律師費）。(b) 同意彌償並使被豁免方免受損害。<br><br>2.3 責任上限：在法律允許之最大範圍內，本公司因本條款或本服務而對參加者所負之全部責任，其總額均不得超過參加者就該次活動向本公司支付之服務費用。",
    "terms.article3.title": "第三條：預訂、付款、取消及改期",
    "terms.article3.content": "3.1 預訂必須於本公司指定之期限內支付訂金方告確認。餘款須於活動日前指定期限內全數繳清。<br><br>3.2 **取消及改期政策：**<br>(a) **由參加者提出取消：**於預定活動日 **14天或之前** 通知取消，可免費改期。於預定活動日 **前7至14天內** 通知取消，可獲退還 **50%**。於預定活動日 **前7天內** 通知取消，**所有已支付費用將概不退還**。<br>(b) **由本公司提出取消/改期：**若因安全理由導致活動無法進行，本公司將盡力協助參加者改期。若無法改期，本公司將全數退還活動費用。",
    "terms.article4.title": "第四條：活動當日守則與客戶責任",
    "terms.article4.content": "4.1 參加者必須於指定時間到達指定集合地點。遲到者可能導致活動被取消，且不獲退款。<br><br>4.2 參加者必須參與強制性的安全簡報，並於活動全程嚴格遵守本公司教練及工作人員之一切指示。<br><br>4.3 參加者需自備合適之運動服裝及包覆腳踝之運動鞋。<br><br>4.4 參加者須自行保管其個人物品。本公司對任何財物之損失或損壞概不負責。",
    "terms.article5.title": "第五條：保險與個人資料",
    "terms.article5.content": "5.1 本公司已購買法律要求之第三者責任保險。**此保險並不涵蓋參加者之人身意外傷害。** 本公司強烈建議參加者自行購買足額之個人意外保險。<br><br>5.2 為遵守《個人資料（私隱）條例》，本公司收集之個人資料將僅用於處理預訂、提供服務、安全及內部行政之用。詳情請參閱本公司之私隱政策聲明。",
    "terms.article6.title": "第六條：影像使用",
    "terms.article6.content": "本公司或其指定人員可能於活動期間拍攝照片或影片作安全記錄、員工培訓、品質控制及宣傳推廣之用。除非參加者於活動前以書面明確反對，否則即被視為授予本公司一項永久、免版稅、不可撤銷的全球性許可。",
    "terms.article7.title": "第七條：一般條款",
    "terms.article7.content": "7.1 **完整性：** 本條款構成雙方就本服務之完整協議。<br><br>7.2 **可分割性：** 若本條款任何部分被裁定為無效，其餘部分仍保持完全效力。<br><br>7.3 **修改權：** 本公司保留隨時修訂本條款之權利。<br><br>7.4 **通知：** 所有通知應以電郵或本公司網站公告方式發出。",
