...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "terms.article1.1":
      "1.1 The Participant must be at least 18 years old on the activity date and present a valid Hong Kong identity card or travel document with a photograph for verification.",
    "terms.article1.2":
      "1.2 The Participant's weight must be 100 kilograms or less, and their height-to-weight ratio must comply with the operational specifications of the safety equipment used by the Company. The Company reserves the right to conduct final measurements on the activity day. Should the Participant exceed these safety limits, the Company has the right to unilaterally refuse participation, and all fees paid will be non-refundable.",
    "terms.article1.3":
      "1.3 The Participant declares they are in good physical and mental health and are fit to participate in high-altitude and high-intensity sporting activities. **The Participant must confirm and warrant that they do not have any of the following conditions (including but not limited to): heart disease, hypertension, spinal or neck injuries, epilepsy, pneumothorax, pregnancy or potential pregnancy, any condition that may be aggravated by changes in air pressure or severe impact, and any mental condition that may affect their ability to understand safety instructions or assess risks.** The Company strongly advises the Participant to consult a qualified medical practitioner before booking to assess their personal suitability.",
    "terms.article1.4":
      "1.4 The Participant must not be under the influence of alcohol, illegal drugs, or any substance that may impair consciousness, judgment, coordination, or reaction time before and during participation. The Company's staff has absolute discretion to determine the Participant's suitability for participation. If deemed unsuitable, the Company has the right to immediately cancel their participation without refund.",

    "terms.article2.title": "2: Acknowledgement of Risk and Liability Waiver",
    "terms.article2.1":
      "2.1 **Inherent Risks:** The Participant expressly knows, understands, and acknowledges that skydiving is an extreme sport with inherent and significant risks, which can lead to serious bodily injury, permanent disability, or death. These risks include, but are not limited to: aircraft incidents during takeoff, flight, or landing; collisions during exit from the aircraft, freefall, parachute deployment, or landing; equipment malfunction, failure, or misuse; sudden changes in weather conditions; errors in judgment or negligence by the instructor, Participant, other persons, or third parties; and landing in unintended areas or colliding with obstacles.",
    "terms.article2.2":
      '2.2 **Waiver, Release, and Indemnity:** In consideration of the Company providing the Service, the Participant, on behalf of themselves, their heirs, executors, and administrators, hereby makes the following irrevocable commitments:<br><br>(a) **Fully releases, waives, and forever discharges** the Company, its directors, officers, employees, contracted instructors, agents, subcontractors, and aviation service providers (collectively, the "Released Parties") from any and all claims, demands, causes of action, losses, liabilities, damages, costs, and expenses (including reasonable legal fees) arising from or related to the Service, **regardless of whether such liability arises from any negligence, fault, breach of statutory duty, or other cause attributable to any Released Party, and regardless of whether it arises from any latent defect in the equipment, premises, or aircraft provided by the Company, except for willful misconduct or gross negligence which cannot be excluded by law.**<br><br>(b) **Agrees to indemnify and hold harmless the Released Parties** from and against any and all claims, liabilities, damages, and expenses directly or indirectly resulting from the Participant\'s participation in the Service, breach of any warranty or provision herein, or any act or omission by the Participant.',
    "terms.article2.3":
      "2.3 **Limitation of Liability:** To the fullest extent permitted by law, the Company's total liability to the Participant arising under or in connection with these Terms or the Service, whether in contract, tort (including negligence), or any other legal theory, shall not exceed the total service fee paid by the Participant for the specific activity.",

    "terms.article3.title": "3: Booking, Payment, Cancellation, and Rescheduling",
    "terms.article3.1":
      "3.1 A booking is confirmed only upon payment of the deposit within the period specified by the Company. The full balance must be settled before the specified deadline prior to the activity date. Failure to pay may result in cancellation of the booking by the Company, and the deposit paid will be non-refundable.",
    "terms.article3.2":
      '3.2 **Cancellation and Rescheduling Policy:**<br><br>(a) **Cancellation Initiated by Participant:**<br>(i) Cancellation notification received **14 days or more** before the scheduled activity date: Free rescheduling to another available date.<br>(ii) Cancellation notification received **within 7 to 14 days** before the scheduled activity date: **50%** of the fees paid will be refunded.<br>(iii) Cancellation notification received **within 7 days (inclusive)** before the scheduled activity date, or failure to attend on the activity day ("No-Show"): **All fees paid will be non-refundable.**<br><br>(b) **Cancellation/Rescheduling Initiated by the Company:**<br>(i) If the activity cannot proceed due to safety reasons (including but not limited to adverse weather, excessive wind speed, insufficient visibility, low cloud base) or any circumstances beyond the Company\'s reasonable control (e.g., aircraft malfunction, maintenance, air traffic control, government directives, pandemic restrictions, etc.), the Company will endeavour to assist the Participant in rescheduling.<br>(ii) If rescheduling is not possible or the Participant does not accept the proposed alternative date, the Company will refund the full activity fee paid by the Participant.<br>(iii) **Under such circumstances, the Company shall not be liable for any incidental, consequential, or indirect losses incurred by the Participant (including but not limited to travel, accommodation, loss of holiday, etc.), and the Participant shall have no claim against the Company for the same.**',
    "terms.article3.3":
      "3.3 All cancellation or rescheduling requests must be submitted via the Company's designated contact methods (e.g., phone, email) and receive written confirmation from the Company to be effective.",

    "terms.article4.title": "4: Rules of Conduct and Customer Responsibilities on Activity Day",
    "terms.article4.1":
      "4.1 The Participant must arrive at the designated meeting point at the specified time. Late arrival may result in cancellation of the activity without refund.",
    "terms.article4.2":
      "4.2 The Participant must attend the mandatory safety briefing and strictly follow all instructions given by the Company's instructors and staff throughout the activity. Any behaviour endangering the safety of themselves or others will result in immediate termination of participation without refund.",
    "terms.article4.3":
      "4.3 The Participant must bring appropriate sportswear and closed-toe athletic shoes. The Company will provide all necessary safety equipment (including jumpsuit, helmet, goggles, etc.). The Participant must not adjust or interfere with any equipment.",
    "terms.article4.4":
      "4.4 The Participant is responsible for their personal belongings. The Company is not responsible for any loss or damage to personal property left at the Company's premises, vehicles, or aircraft.",

    "terms.article5.title": "5: Insurance and Personal Data",
    "terms.article5.1":
      '5.1 The Company has obtained third-party liability insurance as required by law. **This insurance does not cover personal accident or injury to the Participant.** The Company strongly recommends that the Participant purchases adequate personal accident insurance, which must explicitly cover "skydiving" or "high-risk sporting activities".',
    "terms.article5.2":
      "5.2 To comply with the Personal Data (Privacy) Ordinance, personal data collected by the Company will be used solely for processing bookings, providing the Service, safety purposes, and internal administration. Please refer to the Company's Privacy Policy Statement for details.",
    ...
    "terms.article7.1":
      "7.1 **Entire Agreement:** These Terms constitute the entire agreement between the parties regarding the Service and supersede all prior discussions, communications, and agreements.",
    "terms.article7.2":
      "7.2 **Severability:** If any part of these Terms is held to be invalid or unenforceable by a court of competent jurisdiction, that part shall be severed to the minimum extent necessary, and the remaining parts shall remain in full force and effect.",
    "terms.article7.3":
      "7.3 **Right to Amend:** The Company reserves the right to amend these Terms at any time. The amended Terms will be published on the Company's official website. Continued use of the Service by the Participant after such amendments constitutes acceptance of the revised Terms.",
    "terms.article7.4":
      "7.4 **Notices:** All notices shall be issued via email or announcement on the Company's website.",
    ...
    "terms.importantConfirmation.content":
      "**I (the Participant) confirm that I have carefully read and fully understand all contents of these Terms and Conditions, especially the parts highlighted in bold. I clearly acknowledge the inherent risks of skydiving activities and voluntarily assume these risks. I understand and agree to the provisions regarding liability waiver, release of claims, and indemnification in these Terms, which are a necessary condition for my participation in the activity.**",
  ...
  "zh-TW": {
    ...
    // Terms of Service - Traditional Chinese (FIXED STRUCTURE)
    "terms.title": "條款及細則",
    "terms.lastUpdated": "*最後修改時間：2026年1月30日*",

    "terms.preamble.title": "前言",
    "terms.preamble.1":
      "1.1 本《條款及細則》（下稱「本條款」）構成閣下（下稱「參加者」或「客戶」）與Let's Skydive HK Limited（下稱「本公司」或「我們」）就提供跳傘活動服務（下稱「本服務」）所訂立之法律協議。本條款受香港特別行政區法律管轄及解釋。",
    "terms.preamble.2":
      "1.2 閣下透過任何途徑確認預訂、支付款項或參與本服務，即表示閣下已閱讀、理解並無條件接受本條款之全部內容，對閣下具有法律約束力。若閣下為他人代為預訂，即被視為已獲該等人士之充分授權代表其同意受本條款約束。",

    "terms.article1.title": "第一條：資格、健康與安全",
    "terms.article1.1": "1.1 參加者必須於活動當日年滿18歲，並出示附有相片之有效香港身份證或旅遊證件以供核實。",
    "terms.article1.2":
      "1.2 參加者之體重必須為100公斤或以下，且身高體重比例須符合本公司所使用安全裝備之操作規格。本公司保留於活動當日進行最終測量之權利。若參加者超出此安全限制，本公司有權單方面拒絕其參與，已繳付之所有費用將不予退還。",
    "terms.article1.3":
      "1.3 參加者聲明其身心健康狀況良好，適宜參與高空及高強度之體育活動。**參加者必須確認並保證其並無以下任何狀況（包括但不限於）：心臟病、高血壓、脊椎或頸部損傷、癲癇、氣胸、懷孕或可能懷孕、任何可能因氣壓變化或劇烈衝擊而惡化之病症，以及任何精神狀況以致影響其理解安全指示或判斷風險之能力。** 本公司強烈建議參加者在預訂前諮詢合資格醫生以評估自身狀況。",
    "terms.article1.4":
      "1.4 參加者在參與活動前及期間，不得受酒精、非法藥物或任何可能損害神智、判斷力、協調能力或反應能力之藥物影響。本公司職員有絕對酌情權判斷參加者是否適合參與，若判斷為不適合，有權即時取消其參與資格而不作退款。",

    "terms.article2.title": "第二條：風險確認與責任豁免",
    "terms.article2.1":
      "2.1 **固有風險之確認：** 參加者明確知悉、理解並承認，跳傘乃一項具有固有及顯著風險之極限運動，此等風險可導致嚴重身體受傷、永久傷殘、甚或死亡。此等風險包括但不限於：起飛、飛行或降落時之航空器事故；跳出航空器、自由墜落、開傘或著陸過程中發生之碰撞；裝備故障、失靈或不當使用；天氣狀況突然變化；教練、參加者、其他人士或第三方之錯誤判斷或疏忽；以及著陸於非預定區域或與障礙物碰撞。",
    "terms.article2.2":
      "2.2 **豁免、放棄索償及彌償：** 為換取本公司提供本服務，參加者在此代表其本人、其繼承人、遺囑執行人及遺產管理人，作出以下不可撤銷之承諾：<br><br>(a) **完全免除、放棄及永久解除** 本公司、其董事、高級職員、僱員、合約教練、代理人、分包商及航空服務供應商（統稱「被豁免方」）因本服務引致或與之相關之任何及所有索償、要求、訴訟因由、損失、法律責任、損害賠償、費用及開支（包括合理律師費），**無論該等責任因被豁免方之任何疏忽、過失、違反法定責任或其他原因而產生，亦不論是否因本公司所提供之設備、場所或航空器之任何潛在缺陷而引致，惟法律明令禁止豁免之故意失當行為或重大過失除外。**<br><br>(b) **同意彌償並使被豁免方免受損害**，保障其免受因參加者參與本服務、違反本條款任何保證或規定、或其任何作為或不作為而直接或間接導致之任何及所有索償、法律責任、損害及開支。",
    "terms.article2.3":
      "2.3 **責任上限：** 在法律允許之最大範圍內，本公司因本條款或本服務而對參加者所負之全部責任，不論於合約法、侵權法（包括疏忽）或其他法律原則下產生，其總額均不得超過參加者就該次活動向本公司支付之服務費用。",

    "terms.article3.title": "第三條：預訂、付款、取消及改期",
    "terms.article3.1":
      "3.1 預訂必須於本公司指定之期限內支付訂金方告確認。餘款須於活動日前指定期限內全數繳清。逾期未付，本公司有權取消預訂，已付訂金將不予退還。",
    "terms.article3.2":
      "3.2 **取消及改期政策：**<br><br>(a) **由參加者提出取消：**<br>(i) 於預定活動日 **14天或之前** 通知取消，可免費改期至另一可供預訂之日期。<br>(ii) 於預定活動日 **前7至14天內** 通知取消，可獲退還已支付費用之 **50%**。<br>(iii) 於預定活動日 **前7天內（含第7天）** 通知取消，或於活動當日未能出席（「No-Show」），**所有已支付費用將概不退還**。<br><br>(b) **由本公司提出取消/改期：**<br>(i) 若因安全理由（包括但不限於惡劣天氣、風速過高、能見度不足、雲層過低）或任何超出本公司合理控制範圍之情況（如航空器故障、維修、空中交通管制、政府指令、疫症限制等）導致活動無法進行，本公司將盡力協助參加者改期。<br>(ii) 若無法改期或參加者不接受建議之改期日期，本公司將全數退還參加者已支付之活動費用。<br>(iii) **在此等情況下，本公司對參加者因此產生之任何附帶、衍生或間接損失（包括但不限於交通、住宿、假期損失等）概不負責，參加者亦不得就此提出任何索償。**",
    "terms.article3.3":
      "3.3 所有取消或改期要求必須經由本公司指定之聯絡方式（如電話、電郵）提出並獲得書面確認，方為有效。",

    "terms.article4.title": "第四條：活動當日守則與客戶責任",
    "terms.article4.1": "4.1 參加者必須於指定時間到達指定集合地點。遲到者可能導致活動被取消，且不獲退款。",
    "terms.article4.2":
      "4.2 參加者必須參與強制性的安全簡報，並於活動全程嚴格遵守本公司教練及工作人員之一切指示。任何危害自身或他人安全之行為，將導致即時終止參與資格而不作退款。",
    "terms.article4.3":
      "4.3 參加者需自備合適之運動服裝及包覆腳踝之運動鞋。本公司將提供所有必要之安全裝備（包括跳傘服、頭盔、護目鏡等）。參加者不得擅自調校或干預任何裝備。",
    "terms.article4.4":
      "4.4 參加者須自行保管其個人物品。本公司對任何置於本公司場所、車輛或航空器內之財物之損失或損壞概不負責。",

    "terms.article5.title": "第五條：保險與個人資料",
    "terms.article5.1":
      "5.1 本公司已購買法律要求之第三者責任保險。**此保險並不涵蓋參加者之人身意外傷害。** 本公司強烈建議參加者自行購買足額之個人意外保險，且該保險須明確承保「跳傘」或「高危體育活動」。",
    "terms.article5.2":
      "5.2 為遵守《個人資料（私隱）條例》，本公司收集之個人資料將僅用於處理預訂、提供服務、安全及內部行政之用。詳情請參閱本公司之私隱政策聲明。",
    ...
    "terms.article7.1": "7.1 **完整性：** 本條款構成雙方就本服務之完整協議，取代所有先前之討論、通訊及協議。",
    "terms.article7.2":
      "7.2 **可分割性：** 若本條款任何部分被有管轄權之法院裁定為無效或不可執行，該部分應在最小必要範圍內被分割，其餘部分仍保持完全效力。",
    "terms.article7.3":
      "7.3 **修改權：** 本公司保留隨時修訂本條款之權利。修訂後之條款將公佈於本公司官方網站。參加者於修訂後繼續使用服務，即表示接受經修訂之條款。",
    "terms.article7.4": "7.4 **通知：** 所有通知應以電郵或本公司網站公告方式發出。",
    ...
    "terms.importantConfirmation.content":
      "**本人（即參加者）確認已仔細閱讀並完全明白本《條款及細則》之全部內容，特別是其中以粗體標示之部分。本人清楚知悉跳傘活動之固有風險，並自願承擔此等風險。本人理解並同意本條款中關於責任豁免、放棄索償及彌償之規定，此乃本人參與活動之必要條件。**",
