...
const serviceInfo: Record<string, { title: string; subtitle: string; description: string }> = {
  tandem: {
    ...
    description:
      "Experience the thrill of freefall safely strapped to an experienced instructor. No experience needed!",
  },
  a_Licence: {
    title: "A-Licence",
...
export function Services() {
  ...
  const aggregatedServices = useMemo(() => {
    ...
    const grouped = locationServices.reduce(
      (acc, service) => {
    ...
    return Object.entries(grouped)
      .map(([type, data]) => {
        ...
        return {
          type: type as "tandem" | "a_licence" | "group",
          title: info.title,
      ...
      .sort((a, b) => {
        const order = { tandem: 1, a_licence: 2, group: 3 };
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-semibold text-muted-foreground">Choose Your Adventure</span>
            ...
            {aggregatedServices.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Price */}
                  <div className="mb-6">
                    <span className="text-3xl font-black text-foreground">{service.priceRange}</span>
                    <p className="text-sm text-muted-foreground mt-1">Prices vary by location</p>
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 bg-card/50 rounded-2xl px-8 py-4 clean-border mobile-transparent-card">
            ...
            <p className="text-muted-foreground">
              <span className="font-semibold text-foreground">Safety First:</span> All jumps are conducted with
              certified instructors and modern equipment
            </p>
            <div className="w-3 h-3 bg-accent-orange rounded-full" />
          </div>
        </div>
