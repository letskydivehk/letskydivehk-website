        ...
        <div className="mt-20 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-accent-orange/5 to-accent-blue/5 rounded-3xl p-8 lg:p-12 clean-border mobile-transparent-card">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="mb-4">
                Let's Skydive HK was founded by a group of passionate skydivers who wanted to share the incredible
                feeling of freefall with adventure seekers across Asia. What started as a single dropzone has grown into
                a network of world-class facilities across Thailand and China.
              </p>
              <p>
                Today, we're proud to be one of the most trusted names in Asian skydiving. Our team includes
                internationally certified instructors, riggers, and pilots who share one common goal: to give you the
                experience of a lifetime while maintaining the highest safety standards in the industry.
              </p>
            </div>
          </div>
        </div>
