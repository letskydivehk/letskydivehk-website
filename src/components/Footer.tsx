      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="font-bagel text-background text-2xl tracking-wider mb-4">
              LET'S SKYDIVE HK
            </div>
            <p className="text-background/70 leading-relaxed mb-6">
              Experience the thrill of skydiving with Asia's premier dropzone network. 
              Professional tandem jumps, AFF courses, and group events across Thailand and China.
            </p>
            {/* Social Media Icons */}
        ...
        <div className="border-t border-background/20 pt-8 mb-8">
          <div className="flex flex-wrap justify-center gap-8 text-sm text-background/70">
            <a href="mailto:info@letsskydivehk.com" className="flex items-center gap-2 hover:text-background transition-colors">
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-sm text-background/70">
              © 2025 Let's Skydive HK. All rights reserved.
            </div>
            <div className="flex gap-6 text-sm text-background/70">
              <a href="#" className="hover:text-background transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-background transition-colors">Terms of Service</a>
              <a href="#" className="hover:text-background transition-colors">Safety Guidelines</a>
            </div>
          </div>
        </div>
      </div>
