...
export function Footer() {
  ...
  const services = ["Tandem Skydive", "A-Licence", "Group Events", "Gift Vouchers"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-background/70 leading-relaxed mb-6">
              Experience the thrill of skydiving with Asia's premier dropzone network. Professional tandem jumps,
              A-Licence, and group events across Thailand and China.
            </p>
            {/* Social Media Icons */}
