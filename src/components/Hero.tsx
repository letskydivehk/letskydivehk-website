...
export function Hero() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      >
        <div
          className={`w-full px-6 sm:px-8 lg:px-12 py-4 transition-all duration-300 ease-out ${isScrolled ? "bg-black/80 backdrop-blur-xl border-b border-white/10" : "bg-transparent"}`}
        >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            Professional tandem skydiving, A-Licence, and group events across Asia's most stunning dropzones.
          </p>
